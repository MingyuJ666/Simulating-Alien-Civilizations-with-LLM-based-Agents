...
print(action_list.Default['description'])
print(action_list.Passive['Civilization Discovered']['Trigger Condition'])
print(action_list.Active['Request for Cooperation']['description'])